...
set destination=..\_Liveries_-_FA-18C_Perka_VEAF_liveries
...
:_build_version
	...
	set callsign=%~n2
	set destination=%1\Liveries - FA-18C Perka VEAF liveries\Liveries\FA-18C_hornet\14.735 Corsairs - %callsign%
	set texture=%2
	...
	md "%destination%"
	copy "mod\Liveries - FA-18C Perka VEAF liveries\Liveries\FA-18C_hornet\14.735 Corsairs\*" "%destination%\"
	copy %texture% "%destination%\F18C_1_DIFF_default.dds"
	powershell -Command "(gc '%destination%\description.lua') -replace '14.735 Corsairs - Default', '14.735 Corsairs - %callsign%' | sc '%destination%\description.lua'"
GOTO :eof
