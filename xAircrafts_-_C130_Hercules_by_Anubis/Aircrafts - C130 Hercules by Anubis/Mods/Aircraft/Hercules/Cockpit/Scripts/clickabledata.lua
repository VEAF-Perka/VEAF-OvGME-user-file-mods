...
elements["pilot_barometer_setting_knob_CON"] = Knob_Rotate("Altimeter Baro Setting Knob", REFERENCE_SET_MODE_SELECT_PANELS.PILOT_barometric_set_knob)
...
elements["copilot_barometer_setting_knob_CON"] = Knob_Rotate("Altimeter Baro Setting Knob", REFERENCE_SET_MODE_SELECT_PANELS.COPILOT_barometric_set_knob)
