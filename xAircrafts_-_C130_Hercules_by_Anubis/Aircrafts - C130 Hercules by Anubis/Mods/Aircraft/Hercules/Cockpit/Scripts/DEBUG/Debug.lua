...
Click_Value1:set(0.55)--  3.287
Click_Value1_Increment:set(0.1)

Click_Value2:set(0.37)--1.0
Click_Value2_Increment:set(0.1)--

Click_Value3:set(0.25)--0.1
Click_Value3_Increment:set(0.1)
...
Click_Value6:set(-0.38)--
Click_Value6_Increment:set(0.01)

Click_Value7:set(0.0)--
Click_Value7_Increment:set(0.1)

Click_Value8:set(8.0)--
Click_Value8_Increment:set(1.0)

Click_Value9:set(1.0)--
Click_Value9_Increment:set(0.1)

Click_Value10:set(0.0)--
Click_Value10_Increment:set(1.0)
