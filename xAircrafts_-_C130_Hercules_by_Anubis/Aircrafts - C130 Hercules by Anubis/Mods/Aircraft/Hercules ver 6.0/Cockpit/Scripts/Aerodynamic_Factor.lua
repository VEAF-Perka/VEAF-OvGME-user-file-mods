...
local C_D_groundInterAction_factor = get_param_handle("C_D_groundInterAction_factor")
...
-- thrust per engine
EngineThrust_factor:set(0.95)--0.95
...
C_D_0_factor:set(1.5)--4.4

-- Drag due to variation in angle of attack
C_D_alpha_factor:set(0.8)--1.0

-- variation in sideslip angle
...
-- Increase in drag due to ground interaction
C_D_groundInterAction_factor:set(0.5)--
...
L_delta_r_factor:set(100.0)--1.0
