...
vehicle_file("vehicles/Unarmed/AM2Mat_Field_Hide Large.lua")
vehicle_file("vehicles/Unarmed/AM2Mat_Field_Hide_Small.lua")
vehicle_file("vehicles/Unarmed/AM2Mat.lua")
vehicle_file("vehicles/Unarmed/AM2Mat_X4.lua")
vehicle_file("vehicles/Unarmed/AM2Mat_X14.lua")
vehicle_file("vehicles/Unarmed/AM2Mat_X28.lua")
